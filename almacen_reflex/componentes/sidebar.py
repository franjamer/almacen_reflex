...
def sidebar_items() -> rx.Component:
    return rx.vstack(
        sidebar_item("Busqueda", "layout-dashboard" ),
        sidebar_item("Detalle", "square-library" ),
        sidebar_item("Pedidos", "bar-chart-4"),
        sidebar_item("Movimientos de Almacén", "layout-dashboard"),
        sidebar_item("Inventario General", "square-library"),
        spacing="3",
        width="100%",
    )
